window['denylistedDomainsHashedValueListForGpayButtonWithCardInfo'] = [-718583466, -651407173, 1501053020];
...
(function() {
    ...
    */
    ...
    k.la = function(a) {
        ...
        b = a;
        c = Bc.includes(Ra());
        var d = Cc.includes(Ra());
        if ((google.payments.api.EnableDynamicGpayButtonForTesting ||
                google.payments.api.EnableDynamicGpayButton || c) && !d && "short" !== b.buttonType && "plain" !== b.buttonType) a = Dc(a);
        else {
    ...
    var df = null,
        ...
        ff = function(a) {
            ...
            (b = null != b && "PaymentRequest" in
                window && "Google Inc." == window.navigator.vendor && null != c && 59 <= Number(c[1]) && !a.ab.paymentDataCallbacks) || a.h.push(34);
            return b
        };
